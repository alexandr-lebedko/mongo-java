...
public class CommentDao extends AbstractMFlixDao {
    ...
    public Comment addComment(Comment comment) {
        try {
            if (!ObjectId.isValid(comment.getId())) {
                throw new IncorrectDaoOperation("Wrong comment id");
            }
    ...
    public boolean updateComment(String commentId, String text, String email) {
        try {
            ...
            Bson emailFilter = eq("email", email);
            Bson idFilter = eq("_id", new ObjectId(commentId));
            Bson filter = Filters.and(emailFilter, idFilter);
    ...
    public boolean deleteComment(String commentId, String email) {
        ...
        try {
            DeleteResult deleteResult = commentCollection.deleteOne(Filters.and(eq("email", email), eq("_id", new ObjectId(commentId))));
